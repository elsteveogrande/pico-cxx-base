...
[[gnu::section(".boot2")]] [[gnu::used]] [[noreturn]]
inline void _boot2() {
    // Adapted from Pico SDK code, specifically the one for W25Q080 flash (like
    // on the Pico board).  Logic and comments taken from:
    ...
    qspiPads.clkControl().slewFast() = 1;
